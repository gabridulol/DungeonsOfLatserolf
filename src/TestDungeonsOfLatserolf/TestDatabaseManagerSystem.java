...
public class TestDatabaseManagerSystem {
    public static void main(String[] args) {
        ...
        // System.out.println(new DatabaseManagerSystem().allUsers());
        // PlayerEntity playerEntity = new PlayerEntity("gabriel.r.marques@ufv.br", "dulol", 150);
        // int newPlayerScore = 200;
        // new DatabaseManagerSystem().updateUserScore(playerEntity, newPlayerScore);
        //new DatabaseManagerSystem().deleteAllUsers();
    }
}