...
public class MonsterGenerator {
    ...
    public MonsterGenerator() {
        ...
        monsterCategory[0] = new MonsterCategory("Galinha", "Uma ave doméstica que foi transformada em uma fera selvagem por uma maldição. Ela tem penas brancas e pretas, um bico afiado e garras poderosas. Ela ataca com bicadas e arranhões, e pode botar ovos explosivos. Ela é muito barulhenta e agressiva, e não gosta de ser incomodada.", 1, 0.2);
        ...
        monsterCategory[4] = new MonsterCategory("Dragon", "Uma criatura lendária que tem escamas, asas e garras. Ele tem uma cor variada, dependendo de seu elemento, como vermelho para fogo, azul para água, ou verde para terra. Ele usa sua respiração, como fogo, gelo, ou veneno, para atacar seus inimigos. Ele é sábio e orgulhoso, e guarda tesouros e segredos em sua caverna. Ele é respeitado e temido por todos.", 5, 0.1);
    }

    public MonsterEntity generateMonster() {
        while (true) {
            double random = (double) (Math.random());
            int randomMonster = (int) (Math.random() * 5);
